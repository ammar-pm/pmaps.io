                            ...
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active">
                                    <a href="#announcements" aria-controls="announcements" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-bullhorn"></i>{{ __('common.announcements') }}
                                    </a>
                                </li>
                                ...
                                <li role="presentation">
                                    <a href="#metrics" aria-controls="metrics" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-bar-chart"></i>{{ __('common.metrics') }}
                                    </a>
                                </li>
                                ...
                                <li role="presentation">
                                    <a href="#users" aria-controls="users" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-user"></i>{{ __('common.users') }}
                                    </a>
                                </li>
                            </ul>
                        </div>
