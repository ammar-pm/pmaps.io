            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        @if (session('spark:impersonator'))
                            ...
                            <li>
                                <a href="/spark/kiosk/users/stop-impersonating">
                                    <i class="fa fa-fw fa-btn fa-user-secret"></i>{{ __('common.backtomyaccount') }}
                                </a>
                            </li>
                        ...
                        <!-- Settings -->
                        <li class="dropdown-header">{{ __(common.settings) }}</li>

                        <!-- Your Settings -->
                        <li>
                            <a href="/settings">
                                <i class="fa fa-fw fa-btn fa-cog"></i>{{ __('common.yoursettings') }}
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="/logout">
                                <i class="fa fa-fw fa-btn fa-sign-out"></i>{{ __('common.logout') }}
                            </a>
                        </li>
                    </ul>
                </li>
